...
def LoadFirmwareImageFromBuffer(chip, buffer):
    """ Load a firmware image. Can be for any supported SoC.
...
class ImageSegment(object):
    ...
    def __repr__(self):
        ...
        r +=  " include_in_checksum={}".format(self.include_in_checksum)
        return r
...
class BaseFirmwareImage(object):
    ...
    def __init__(self, firmware_image=None, seg_start_address=None, seg_len=-1):
        self.segments = []
        self.entrypoint = 0
    ...
    def __init__(self, load_file=None):
        ...
        if load_file is not None:
            ...
            if self.append_digest:
                ...
                self._image_size = load_file.tell() - start
